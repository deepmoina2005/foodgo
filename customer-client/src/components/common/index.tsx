...
export function Input({
  ...
  return (
    <label className="block space-y-2">
      ...
      <input
        className={clsx(
          'w-full rounded-2xl border border-[color:var(--app-border)] bg-[var(--app-surface-soft)] px-4 py-3.5 text-sm text-[var(--app-text)] outline-none transition-all placeholder:text-[var(--app-muted)] focus:border-brand-500/50 focus:bg-[var(--app-surface)] focus:ring-4 focus:ring-brand-500/10 dark:border-white/10 dark:focus:border-brand-500/50',
...
export function Select({
  ...
  return (
    <label className="block space-y-2">
      ...
      <select
        className={clsx(
          'w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm text-[var(--app-text)] outline-none transition focus:border-brand-400 focus:ring-4 focus:ring-brand-100',
          error ? 'border-rose-300 focus:border-rose-400 focus:ring-rose-100' : '',
          className,
        )}
        {...props}
...
export function Textarea({
  ...
  return (
    <label className="block space-y-2">
      ...
      <textarea
        className={clsx(
          'min-h-32 w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm text-[var(--app-text)] outline-none transition placeholder:text-slate-400 focus:border-brand-400 focus:ring-4 focus:ring-brand-100',
          error ? 'border-rose-300 focus:border-rose-400 focus:ring-rose-100' : '',
          className,
        )}
        {...props}
...
export function Badge({
  ...
  return <span className={clsx('inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold capitalize', tones[tone], className)}>{children}</span>;
}
