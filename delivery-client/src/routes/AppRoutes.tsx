...
import {
  ...
  DeliveryAvailableRequestsPage,
  DeliveryAvailableRequestDetailsPage,
...
function HomeRedirect() {
  ...
  return <Navigate to={role === 'delivery_partner' ? '/delivery/dashboard' : '/login'} replace />;
}
  ...
  return (
    <Route element={<RoleRoute roles={['delivery_partner']} />}>
      <Route element={<DashboardLayout />}>
        ...
        <Route path="/delivery/available-requests" element={<DeliveryAvailableRequestsPage />} />
        <Route path="/delivery/available-requests/:id" element={<DeliveryAvailableRequestDetailsPage />} />
